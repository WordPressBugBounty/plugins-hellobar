<form action="" method="post" id="helloBarAdmin">
    ...
    <div class="wrap" style="margin:0">
        <header><a href="javascript:void(0)" id="helloBasLogo"><img src="<?php echo esc_url( $plugin_path . 'images/logo.png' ); ?>"></a><br><br><span class="hbhdrTitle"><b>Convert</b> visitors into customers with Hello Bar</span></header>
        <div class="tool-box">
...
if ($hellobar_code) {
    ...
    ?>
                <div class="hellobarLable">
                    ...
                    <img src="<?php echo esc_url( $plugin_path . 'images/q.png' ); ?>"></a>
